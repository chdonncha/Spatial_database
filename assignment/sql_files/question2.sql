...
INSERT INTO route (the_geom) select ST_GeomFromText('MULTILINESTRING((10 30, 10 35))',-1);
INSERT INTO route (the_geom) select ST_GeomFromText('MULTILINESTRING((10 0,10 5))', -1);
INSERT INTO route (the_geom) select ST_GeomFromText('MULTILINESTRING((10 5,10 15))', -1);
INSERT INTO route (the_geom) select ST_GeomFromText('MULTILINESTRING((10 15,10 20))', -1);
INSERT INTO route (the_geom) select ST_GeomFromText('MULTILINESTRING((10 20, 10 30))', -1);
